...
const CreateTask=({ onSubmit }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="bg-secondary shadow-md rounded px-8 pt-6 pb-8 mb-4">
      <div className="mb-4">
        <label className="block text-quarternary text-sm font-bold mb-2" htmlFor="title">
          Title
        </label>
        <input
      ...
      <div className="mb-4">
        <label className="block text-quarternary text-sm font-bold mb-2" htmlFor="description">
         Short Description
        </label>
        <textarea
          className="appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
      ...
      <div className="mb-4">
        <label className="block  text-quarternary text-sm font-bold mb-2" htmlFor="ideaDate">
          Found Date
        </label>
        <input
          className="appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
